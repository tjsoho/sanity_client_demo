"use strict";
var fs = require("node:fs"), path = require("node:path"), createDebug = require("debug"), require$$0 = require("fs"), require$$0$1 = require("path"), require$$0$2 = require("os"), require$$3 = require("crypto");
...
var main$2 = { exports: {} }, name = "dotenv", version = "16.4.5", description = "Loads environment variables from .env file", main$1 = "lib/main.js", types = "lib/main.d.ts", exports$1 = {
  ".": {
    types: "./lib/main.d.ts",
    require: "./lib/main.js",
    default: "./lib/main.js"
...
function requireMain$1() {
  ...
  hasRequiredMain$1 = 1;
  const fs2 = require$$0__default.default, path2 = require$$0__default$1.default, os = require$$0__default$2.default, crypto = require$$3__default.default, version2 = require$$4.version, LINE = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
  function parse(src) {
    const obj = {};
