...
function StructureToolBoundary({ tool: { options } }) {
  ...
  return error ? /* @__PURE__ */ jsxRuntime.jsx(StructureError, { error }) : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.ErrorBoundary, { onCatch: setError, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.SourceProvider, { name: source || firstSource.name, children: /* @__PURE__ */ jsxRuntime.jsxs(structure.StructureToolProvider, { defaultDocumentNode, structure: structure$1, children: [
