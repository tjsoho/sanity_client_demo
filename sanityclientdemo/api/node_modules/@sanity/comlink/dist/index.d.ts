 ...
 * @public
 */
export declare type Channel<R extends Message, S extends Message> = {
 ...
 * @public
 */
export declare type ChannelActor<R extends Message, S extends Message> = ActorRefFrom<
 ...
 * @public
 */
export declare type ChannelActorLogic<R extends Message, S extends Message> = ReturnType<
 ...
 * @public
 */
export declare interface ChannelInput {
  connectTo: string
  domain?: string
  heartbeat?: boolean
  name: string
 ...
 * @public
 */
export declare type ConnectionInput = Omit<ChannelInput, 'target' | 'targetOrigin'>

/**
 * @public
 */
export declare interface ConnectionInstance<R extends Message, S extends Message> {
  on: <
    T extends R['type'],
    U extends Extract<
      R,
 ...
 * @public
 */
export declare const createChannel: <R extends Message, S extends Message>(
  input: ChannelInput,
  machine?: ChannelActorLogic<R, S>,
) => Channel<R, S>
 ...
 * @public
 */
export declare const createChannelMachine: <
  R extends Message,
  S extends Message,
 ...
 * @public
 */
export declare const createNode: <R extends Message, S extends Message>(
  input: NodeInput,
 ...
 * @public
 */
export declare type InternalEmitEvent<R extends Message, S extends Message> =
 ...
 * @public
 */
declare type Node_2<R extends Message, S extends Message> = {
  actor: NodeActor<R, S>
 ...
 * @public
 */
export declare type NodeActor<R extends Message, S extends Message> = ActorRefFrom<
  NodeActorLogic<R, S>
>
 ...
 * @public
 */
export declare type NodeActorLogic<R extends Message, S extends Message> = ReturnType<
