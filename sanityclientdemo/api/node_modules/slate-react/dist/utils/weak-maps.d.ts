...
import { Action } from '../../../../packages/slate-react/src/hooks/android-input-manager/android-input-manager';
 ...
 */
export declare const EDITOR_TO_ON_CHANGE: WeakMap<import("../../../../packages/slate-react/src").ReactEditor, (options?: {
    operation?: Operation;
}) => void>;
/**
